...
module.exports = {
  ...
  aragon: {
    ...
    appContractName: 'Batcher',
    appRoles: [
      {
        "name": "Add batched scripts",
        "id": "ADD_SCRIPT_ROLE",
        "params": []
      },
      {
        "name": "Authorize batched scripts",
        "id": "AUTHORIZE_SCRIPT_ROLE",
        "params": []
      },
      {
        "name": "Execute batched scripts",
        "id": "EXECUTE_SCRIPT_ROLE",
        "params": []
      }
    ],
